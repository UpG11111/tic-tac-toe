...
const initialState: InitialState = {
    ...
    history: [Array(initialGameState.boardSize).fill(null)
...
const gameStore = createSlice({
    ...
    reducers: {
        ...
        setGameConfig (state, action: PayloadAction<GameConfig>) {
            ...
            state.history = [Array(action.payload.boardSize).fill(null)
        ...
        setBoardSize (state, action: PayloadAction<number>) {
            ...
            state.winner = null;
            state.history = [Array(action.payload).fill(null)
...
export const { setWinner, setFirstPlayer, setGameConfig, setBoardSize, setHistory, boardChange } = gameStore.actions;
